...
| TEST-30d | Đóng khẩn cấp (`run-mode EMERGENCY`) | Thứ tự Client → Master giữ nguyên, deal đóng Master mang `CLIENT` |
...
| TEST-32m | Ba nút chế độ ở đầu trang | Bấm từng nút → `bridge.admin run-mode` in đúng giá trị tương ứng |
...
**953 test xanh** (`pytest`) + **3 test tải**, `ruff` sạch, ngày 2026-09-21.
