...
class Buoc(NamedTuple):
    ...
    #: (số tài khoản, tên symbol, mã Client), nên Bridge không chạy hộ được.
    #:
    #: Vì sao là một danh sách CẶP chứ không phải hai trường rời: bản đầu có `khoa_lenh` (in ra)
    #: và `ma_chay` (chạy được) tách nhau, và chúng lệch ngay — bước Khai clicker IN `sua-agent`
    #: nhưng nút Chạy của nó chạy `liet-ke`, còn bước Bật copy in `run-mode RUNNING` mà không có
    #: nút nào. Người dùng báo đúng chỗ đó. Buộc chúng đi cùng nhau thì không lệch được nữa.
...
BUOC_LAN_DAU: tuple[Buoc, ...] = (
    ...
    Buoc("LD_BIEN_DICH", "hd_ld_bien_dich", (), NOI_POWERSHELL,
         "hd_ld_bien_dich_viec", "hd_ld_bien_dich_kiem", "hd_ld_bien_dich_bay",
    ...
    Buoc("LD_CAU_HINH_COPY", "hd_ld_cau_hinh_copy", (), NOI_DASHBOARD,
         ...
         lenh=(("hd_lenh_cau_hinh_client", ""),)),
    Buoc("LD_BAT_COPY", "hd_ld_bat_copy", ("CHUA_BAT_COPY",), NOI_DASHBOARD,
         "hd_ld_bat_copy_viec", "hd_ld_bat_copy_kiem", "hd_ld_bat_copy_bay", (HD_BAT_COPY,),
         lenh=(("hd_lenh_run_mode", "RUN_MODE_RUNNING"),)),
    Buoc("LD_THU_DEMO", "hd_ld_thu_demo", (), NOI_MT5,
         "hd_ld_thu_demo_viec", "hd_ld_thu_demo_kiem", "hd_ld_thu_demo_bay",
         lenh=(("hd_lenh_kiem_reason", "KIEM_REASON"),
          ("hd_lenh_kiem_dong_sai", "KIEM_DONG_SAI"))),
)
...
BUOC_SAU_UPDATE: tuple[Buoc, ...] = (
    ...
    Buoc("UP_CODE_CU", "hd_up_code_cu", (), NOI_POWERSHELL,
         "hd_up_code_cu_viec", "hd_up_code_cu_kiem", "",
         lenh=(("hd_lenh_kiem_tra", "KIEM_TRA"),)),
    Buoc("UP_CONFIG_SOT", "hd_up_config_sot", ("CONFIG_CON_KHOA_CLICKER",), NOI_DASHBOARD,
         "hd_up_config_sot_viec", "hd_up_config_sot_kiem", "hd_up_config_sot_bay", (HD_KHOI_FILE_CONFIG,)),
    Buoc("UP_BAT_COPY", "hd_up_bat_copy", ("CHUA_BAT_COPY",), NOI_DASHBOARD,
         "hd_up_bat_copy_viec", "hd_up_bat_copy_kiem", "", (HD_BAT_COPY,),
         lenh=(("hd_lenh_run_mode", "RUN_MODE_RUNNING"),)),
    Buoc("UP_TINH_HINH", "hd_up_tinh_hinh", (), NOI_POWERSHELL,
         "hd_up_tinh_hinh_viec", "hd_up_tinh_hinh_kiem", "",
         lenh=(("hd_lenh_tinh_hinh", "TINH_HINH"),)),
)
...
def _mot_buoc(b: Buoc, thieu: list[dict[str, Any]], da_tich: set[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "lenh": [{"chu": UI[k], "ma_chay": mc} for k, mc in b.lenh],
